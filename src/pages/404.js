        ...
        <section class="bg-white dark:bg-gray-900 h-[90vh]">
            <div class="container min-h-screen px-6 py-12 mx-auto lg:flex items-center lg:gap-12">
                ...
                <div class="w-full lg:w-1/2">
                    <p class="text-sm font-medium text-blue-500 dark:text-blue-400">خطای 404</p>
                    ...
                    <div class="flex items-center mt-6 gap-x-3">
                        ...
                        <Link href={'/'} class=" px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            خانه
                        </Link>
                    </div>
                </div>
