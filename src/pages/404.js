    ...
    return (
        <section className="bg-white h-[90vh]">
            <div className="container min-h-screen px-6 py-12 mx-auto lg:flex items-center lg:gap-12">
                <div className="relative sm:w-full flex justify-center items-center lg:w-1/2">

                    <svg width="400" height="164" viewBox="0 0 514 164" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="101" cy="22" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="101" cy="142" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="21" cy="102" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="141" cy="102" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="193" cy="82" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="313" cy="82" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="253" cy="22" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="253" cy="142" r="20" stroke="#00ae8e" stroke-width="2" />
                        ...
                        <circle cx="453" cy="22" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="453" cy="142" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="373" cy="102" r="20" stroke="#00ae8e" stroke-width="2" />
                        <circle cx="493" cy="102" r="20" stroke="#00ae8e" stroke-width="2" />
                ...
                <div className="w-full lg:w-1/2">
                    <p className="text-sm font-medium text-green ">خطای 404</p>
                    <h1 className="mt-3 text-2xl text-gray-500 md:text-3xl">صفحه مورد نظر پیدا نشد. </h1>
                    <p className="mt-4 text-gray-500">صفحه ای که شما دنبال آن هستید، پیدا نشد. لینک های زیر کمک کننده هستند:</p>

                    <div className="flex items-center mt-6 gap-x-3">
                        <button className="flex items-center justify-center px-5 py-2 text-sm text-gray-700 transition-all duration-300 bg-white border rounded-lg gap-x-2 w-auto hover:bg-gray-100 ">
                        ...
                        <Link href={'/'} className=" px-5 py-2 text-sm tracking-wide text-white transition-all duration-300 bg-green rounded-lg shrink-0 sm:w-auto hover:opacity-[80%]">
                            خانه
                        </Link>
                    </div>
                </div>
