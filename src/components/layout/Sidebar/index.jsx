...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside id="default-sidebar" className="hidden lg:flex flex-col justify-between w-[100%] lg:w-[15%] h-[100vh] fixed top-0 right-0 z-40 transition-transform -translate-x-full sm:translate-x-0 border-l-[1px]" aria-label="Sidebar">
                <div>
                        ...
                        <div className="basis-[100%] m-2">
                            ...
                            <form>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="search" id="default-search" className="outline-0 block w-full py-2 pl-5 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green focus:border-blue-green dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="جستوجو کنید..." required />
                    ...
                    <div className="">
                        ...
                        {/* <menu id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar"> */}
