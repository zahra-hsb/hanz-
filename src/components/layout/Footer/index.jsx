                        ...
                        <div className='lg:ml-40'>
                            ...
                            <div>
                                <ul className='pt-4 text-sm sm:text-lg flex justify-between'>
                                    ...
                                    <Link href={'https://www.instagram.com/shaycogroup'} target='_blank' className='group hover:border-none hover:bg-white cursor-pointer ml-2 w-[28px] h-[28px] border-[1px] rounded-full flex justify-center items-center'>
