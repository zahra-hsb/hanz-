...
const Footer = () => {
    return (
        <>
            <footer className="flex flex-col w-full bg-green text-white pt-20 pb-6 px-20 leading-8">
                <div className="flex justify-between flex-wrap w-[90%] m-auto">
                    <div className="flex justify-between flex-wrap basis-[60%]">
                        <div>
                            <div>
                                <h2 className="font-extrabold text-xl">محصولات</h2>
                            </div>
                            <div className='pt-8'>
                                <ul>
                        ...
                        <div>
                            <div>
                                <h2 className="font-extrabold text-xl">تماس با ما</h2>
                            </div>
                            <div>
                                <ul className='pt-8'>
