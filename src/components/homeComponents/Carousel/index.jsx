            ...
            <section className="flex flex-col w-full py-5 sm:mb-36 mb-24 mt-16">
                <div className="lg:w-[90%] lg:m-auto">
                    ...
                    <div id="home-carousel">
                        <Slider slidesPerView={3} image1={image1} image2={image2} image3={image3} image4={image4} textSlider={true} textSlider1={'چرخه زندگی آلومینیوم'} textSlider2={'عایق صوتی: صدای ناخواسته داخل خانه را کاهش دهید'} textSlider3={'عایق صوتی: صدای ناخواسته داخل خانه را کاهش دهید'} textSlider4={'چرخه زندگی آلومینیوم'} sliderCount={''} />
                    </div>
                </div>
            </section>
        </>
