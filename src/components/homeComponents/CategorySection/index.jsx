            ...
            <section className="flex flex-col w-full items-center mt-10">
                <div className="flex flex-col lg:w-[90%] lg:m-auto w-full items-center ">
                    ...
                    <div className="flex flex-row w-full gap-3 items-center justify-around flex-wrap">
                        <Link href={'/products/building'} className="flex flex-col items-center justify-between cursor-pointer  hover:text-green hover:opacity-100">
                            ...
                            <p className="mt-4 text-base opacity-[65%] font-bold">ساختمانی</p>
                        </Link>
                        <Link href={'/products/industrial'} className="flex flex-col items-center justify-between cursor-pointer  hover:text-green hover:opacity-100">
                            <div className="lg:w-[200px] w-[180px] lg:h-[200px] h-[180px] flex items-center justify-center bg-green rounded-2xl hover:shadow-2xl">
                                <svg width="115" height="115" viewBox="0 0 135 135" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="mt-4 text-base opacity-[65%] font-bold">صنعتی</p>
                        </Link>
                        <Link href={'/products/services'} className="flex flex-col items-center justify-between cursor-pointer hover:text-green hover:opacity-100">
                            <div className="lg:w-[200px] w-[180px] lg:h-[200px] h-[180px] flex items-center justify-center bg-green rounded-2xl hover:shadow-2xl">
                            ...
                            <p className="mt-4 text-base opacity-[65%] font-bold">خدمات</p>
                        </Link>
                        <Link href={'/products/accessory'} className="flex flex-col items-center justify-between cursor-pointer hover:text-green hover:opacity-100">
                            <div className="lg:w-[200px] w-[180px] lg:h-[200px] h-[180px] flex items-center justify-center bg-green rounded-2xl hover:shadow-2xl">
                            ...
                            <p className="mt-4 text-base opacity-[65%] font-bold">اکسسوری</p>
                        </Link>
                    </div>
                </div>
            </section>
