            ...
            <section className="p-10">
                <div className="flex items-center justify-center flex-wrap gap-16 p-5">
                    <div className="group flex flex-col items-center justify-between gap-5 relative cursor-pointer overflow-hidden lg:w-[28%]">
                        ...
                        <Button title={'نمایش بیشتر'} url={''} border={'opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 border-2 border-white absolute mt-[80px]'} color={'text-white'} hover={'hover:text-black hover:bg-white'} onClick={showModal} />
