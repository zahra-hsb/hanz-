...
const GalleryModal = ({ mainPic, closeModal, opacity, wraperOpacity, galleryProp }) => {
    ...
    return (
        <>
            ...
            <section className={`${opacity} rounded-md overflow-hidden transition duration-500 ease-in-out fixed sm:top-[50%] top-[10%] sm:left-[50%] lg:p-10 sm:ml-[-40vw] sm:mt-[-45vh] w-[90%] sm:w-[80vw] sm:h-[90vh] bg-white`}>
                <div>
