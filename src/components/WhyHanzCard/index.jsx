                ...
                <div className="bg-gray-100 rounded-lg mx-4 sm:mx-0">
                    <div class="container px-6 mx-auto grid">
                        ...
                        <div class="grid gap-6 my-8 md:grid-cols-2 xl:grid-cols-4">
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                                <div class="p-3 ml-4 text-green bg-[#ccfbf1] rounded-full">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                                            d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                                        </path>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                                <div class="p-3 ml-4 text-red-500 bg-red-100 rounded-full">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                                            d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                                        </path>
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                                <div
                                    class="p-3 ml-4 text-yellow-500 bg-yellow-100 rounded-full">
